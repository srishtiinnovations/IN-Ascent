...
#Region "Menus"
    ...
    Private Sub createTables()
        ...
        Try
            ...
            objUDFEngine.AddAlphaField("@SST_NPLANHDR", "supcode", "Supplier code", 200)
            ...
            objUDFEngine.AddAlphaField("@SST_PRDQCDTL", "samno", "Sample no", 5)
            objUDFEngine.AddAlphaField("@SST_PRDQCDTL", "pcode", "Parameter Code", 20)
            objUDFEngine.AddAlphaField("@SST_PRDQCDTL", "paradesc", "Parameter Desc", 40)
            objUDFEngine.AddAlphaField("@SST_PRDQCDTL", "uomcode", "Uom code", 20)
            objUDFEngine.AddAlphaField("@SST_PRDQCDTL", "uom", "Uom Name", 40)
            objUDFEngine.AddAlphaField("@SST_PRDQCDTL", "compsts", "Computed Status", 30)
            objUDFEngine.AddFloatField("@SST_PRDQCDTL", "value", "Param.value", SAPbobsCOM.BoFldSubTypes.st_Quantity)
            objUDFEngine.AddFloatField("@SST_PRDQCDTL", "tolladd", "Tolerence(+)", SAPbobsCOM.BoFldSubTypes.st_Quantity)
            objUDFEngine.AddFloatField("@SST_PRDQCDTL", "tollsub", "Tolerence (-)", SAPbobsCOM.BoFldSubTypes.st_Quantity)
            objUDFEngine.AddFloatField("@SST_PRDQCDTL", "actlval", "Actual Value", SAPbobsCOM.BoFldSubTypes.st_Quantity)
