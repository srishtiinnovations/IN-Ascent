...
Public Class ProductionReport2N
    ...
    Public Property FullResourceName() As String
        Get
            Return "Engineering_AddOn.ProductionReport2N.rpt"
        End Get
...
Public Class CachedProductionReport2N
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProductionReport2N = New ProductionReport2N
        rpt.Site = Me.Site
        Return rpt
    End Function
