...
Public Class clsAddOn
    ...
    Private Sub createTables()
        ...
        objUDFEngine.AddNumericField("@PSSIT_OCON", "SqlSer", "SqlSer", 100)
        objUDFEngine.AddNumericField("@PSSIT_OCON", "SqlUID", "SqlUID", 10)
        objUDFEngine.AddNumericField("@PSSIT_OCON", "SqlPwd", "SqlPwd", 100)
        'Added by Manimaran----------e
