...
Public Class clsAddOn
    ...
    Private Sub createTables()
        ...
        objUDFEngine.CreateTable("PSSIT_PEY2", "ProductionEntryRows-Labour", SAPbobsCOM.BoUTBTableType.bott_NoObject)
        ...
        objUDFEngine.CreateTable("PSSIT_PEY3", "ProductionEntryRows-Tools", SAPbobsCOM.BoUTBTableType.bott_NoObject)
        ...
        objUDFEngine.CreateTable("PSSIT_PEY4", "ProductionEntry-FixedCost", SAPbobsCOM.BoUTBTableType.bott_NoObject)
        ...
        objUDFEngine.CreateTable("PSSIT_OTYP", "WorkCentreType", SAPbobsCOM.BoUTBTableType.bott_MasterData)
    ...
    Private Sub CreateUDOS()
        ...
        Ct(0) = ""
        createUDO("PSSIT_OTYP", "PSSIT_WCT", Ct, SAPbobsCOM.BoUDOObjType.boud_MasterData, True, True)
        Ct(0) = ""
            ...
            If DfltForm = True Then
                ...
                Select Case udoname
                    ...
                    Case "PSSIT_MAK"
                        ...
                        oUserObjectMD.FormColumns.FormColumnDescription = "MakeName"
                        oUserObjectMD.FormColumns.Add()
